    ...
    public class Area1Content : AreaContent
    {
        ...
        protected virtual void GenerateWalls()
        {
            ...
            if (World.currentDifficulity == Difficulity.EASY)
            {
                ...
                SmartPosWall(1000, 3800, 1000, 4200);
                SmartPosWall(0, 2850, 400, 2850);
            }
        ...
        protected void GenInteractiveEnvironment()
        {
            ...
            CreateDuoLever(new Vector3(4000, 0, 2500), new Vector3(0, 90, 0), 100, Vector3.Forward,
                           new Vector3(1500, 0, 1100), new Vector3(0, 180, 0), 100, Vector3.Backward, gate, 12.0f);
