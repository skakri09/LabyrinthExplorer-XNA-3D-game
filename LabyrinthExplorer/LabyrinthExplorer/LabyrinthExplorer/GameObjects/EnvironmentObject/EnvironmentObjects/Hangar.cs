...
namespace LabyrinthExplorer
{
    ...
    {
        HangarSound ww2 = new HangarSound("ww2", new Vector3(5183, 0, 21400), 0.5f);
        HangarSound alex = new HangarSound("alex", new Vector3(5350, 0, 10700));
        HangarSound apollo11 = new HangarSound("apollo11", new Vector3(2445, 0, 21400));
        HangarSound arena = new HangarSound("arena", new Vector3(7800, 0, 21400));
        HangarSound egypt = new HangarSound("egypt", new Vector3(7800, 0, 10700));
