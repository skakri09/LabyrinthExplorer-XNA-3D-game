...
{
    public class NormalMappedCeiling
    {
        private VertexBuffer vertexBuffer;
        private NormalMappedVertex[] vertices;

        /// <summary>
        /// Generates a ceiling from the 4 corners. They should be in the following format:
        ...
        public NormalMappedCeiling(GraphicsDevice graphicsDevice, Vector3 corner1, Vector3 corner2,
                    Vector3 corner3, Vector3 corner4, Vector3 normal)
        {
            GenerateCeiling(graphicsDevice, corner1 * GameConstants.MAP_SCALE, corner2 * GameConstants.MAP_SCALE, corner3 * GameConstants.MAP_SCALE, corner4 * GameConstants.MAP_SCALE, normal);
        }
